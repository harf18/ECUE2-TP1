...
$ cd ECUE2
```
- Sur github, sur la page d'accueil du projet, cliquer sur le bouton vert "code" et copier le l'url qui s'affiche (```https://github.com/youruser/ECUE...```)
...
- Ouvrir le projet ECUE2-TP1 :
	...
	- Dans **SDK** sélectionner **add SDK** et selectionner votre jdk
	- Sélectionner la dernière version et cliquer sur **Download**
	- Cliquer sur **Ok**

### Votre 1er programme Java
...
- Sélectionner **base repository** = *harf18/ECUE2-TP1* 
- Sélectionner **compare** = votre branche *prenomNom*

Vous devez voir alors vos modifications
